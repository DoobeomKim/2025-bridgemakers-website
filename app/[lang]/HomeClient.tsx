...
function ContactButton({ dictionary }: { dictionary: any }) {
  ...
  return (
    <button 
      ...
      <span className="font-medium text-[13px] sm:text-[14px] tracking-[0.25px]">{dictionary.home.hero.cta}</span>
...
export default function HomeClient({ locale, projects, dictionary }: HomeClientProps) {
          ...
          <div className="flex flex-col justify-center w-full md:w-2/3 py-4 sm:py-8 md:py-20">
            ...
            <div className="relative">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-white tracking-[0.5px] leading-[1.2] mb-5 sm:mb-8 md:mb-12 max-w-4xl pl-0">
                <span className="block mb-2 sm:mb-3 md:mb-5">{dictionary.home.hero.title.line1}</span>
                <span className="block sm:whitespace-nowrap md:text-4xl lg:text-5xl">{dictionary.home.hero.title.line2}</span>
              </h1>
            </div>
      ...
      <section className="py-12 sm:py-16 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-lg sm:text-xl font-medium text-white tracking-[0.5px] leading-[1.2] mb-2">{dictionary.home.video.title}</h2>
          </div>
                  ...
                  {!isVideoModalOpen ? (
                    <>
                      ...
                      >
                        ...
                        <span className="absolute bottom-4 sm:bottom-6 text-center play-btn-label text-xs sm:text-sm">{dictionary.home.video.play}</span>
                      </button>
                    </>
                  ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-10 sm:mt-14 px-2 sm:px-4">
            ...
            <div className="feature-card rounded-xl p-4 sm:p-6 shadow-lg">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-base sm:text-lg font-bold text-white mb-1 sm:mb-2">{dictionary.home.features.creative.title}</h3>
                <p className="text-xs sm:text-sm text-[#C7C7CC] leading-relaxed">
                  {dictionary.home.features.creative.description}
                </p>
              </div>
            </div>
            ...
            <div className="feature-card rounded-xl p-4 sm:p-6 shadow-lg">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-base sm:text-lg font-bold text-white mb-1 sm:mb-2">{dictionary.home.features.strategy.title}</h3>
                <p className="text-xs sm:text-sm text-[#C7C7CC] leading-relaxed">
                  {dictionary.home.features.strategy.description}
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-[rgba(203,169,103,0.1)] text-[#cba967] rounded-[16px] mb-3 sm:mb-4">
                  <img
                    ...
                    alt={dictionary.home.features.localized.title}
                    width={24}
                    height={24}
                    className="w-6 h-6 sm:w-8 sm:h-8"
                  />
                </div>
                <h3 className="text-base sm:text-lg font-bold text-white mb-1 sm:mb-2">{dictionary.home.features.localized.title}</h3>
                <p className="text-xs sm:text-sm text-[#C7C7CC] leading-relaxed">
                  {dictionary.home.features.localized.description}
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-[22px] sm:text-[24px] md:text-[28px] font-bold text-white tracking-[0.5px] leading-[1.2]">{dictionary.home.projects.title}</h2>
          ...
          <div className="text-center mt-8 sm:mt-10 md:mt-12">
            ...
            >
              <span className="font-medium text-[12px] sm:text-[14px] tracking-[0.25px]">{dictionary.home.projects.viewAll}</span>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-[#050a16]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-8 md:mb-10">
            <h2 className="text-[22px] sm:text-[24px] md:text-[28px] font-bold text-white tracking-[0.5px] leading-[1.2]">{dictionary.home.instagram.title}</h2>
            <div className="mt-2 w-16 sm:w-20 h-1 bg-[#cba967] mx-auto"></div>
            <p className="text-[#C7C7CC] text-sm sm:text-base max-w-2xl mx-auto mt-3 sm:mt-4">
              {dictionary.home.instagram.description}
            </p>
          </div>
          ...
          <div className="text-center mt-6 sm:mt-8 md:mt-10">
            ...
            >
              ...
              <span className="font-medium text-[12px] sm:text-[14px] tracking-[0.25px]">{dictionary.home.instagram.follow}</span>
            </a>
          </div>
        </div>
      </section>
