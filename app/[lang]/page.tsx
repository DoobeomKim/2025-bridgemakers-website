  ...
  const caseStudies = [
    {
      ...
      title: "Bridge Makers 2023 Video Showreel",
      description: "Bridge Makers의 2023년 주요 작업을 소개하는 쇼릴 비디오 프로젝트입니다.",
      href: `/${locale}/(public)/case-studies/showreel-2023`
    },
    {
      id: 2,
      thumbnail: "/images/case-study-2.jpg",
      title: "Rehabilitation Trade Fair Exhibition",
      description: "재활의학 박람회를 위한 전시 비디오 제작 프로젝트입니다.",
      href: `/${locale}/(public)/case-studies/rehabilitation-fair`
    }
  ];
  */
